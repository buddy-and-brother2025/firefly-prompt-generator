...
index 0000000000000000000000000000000000000000..ba18f246dc21f5ec84f80509b0c6192bc0a9fa99 100644
--- a//dev/null
+++ b/script.js
@@ -0,0 +1,114 @@
+const data = [
...
+  if (childrenWrap) childrenWrap.remove();
+
+  event.target.classList.add('active');
+
+  if (tag.children) {
+    const childWrap = document.createElement('div');
+    childWrap.className = 'buttons';
